...
import { FaSearch, FaChartLine, FaBell, FaGlobeAfrica, FaUsers, FaEnvelope } from 'react-icons/fa';
    ...
    return (
        ...
        >
            <div className="text-2xl font-bold">
                <CountUp isCounting end={parseInt(value)} duration={2.5} />{value.includes('%') ? '%' : '+'}
            </div>
        ...
        <div className="bg-white pt-16">
            ...
            <section className="relative h-screen flex items-center overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        >
                            AI-powered early warning platform for potential outbreaks, re-outbreaks, and neglected tropical diseases.
                        </motion.p>
                        <motion.div 
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        >
                            ...
                            >
                                <Link 
                                    to="/explore" 
                                    className="bg-white text-emerald-700 px-6 py-3 rounded-lg hover:bg-emerald-100 transition duration-300 font-medium"
                                >
                                    Explore Platform
                                </Link>
                            </motion.div>
                            ...
                            >
                                <Link 
                                    to="/get-involved" 
                                    className="bg-transparent border-2 border-white px-6 py-3 rounded-lg hover:bg-white hover:text-emerald-700 transition duration-300 font-medium"
                                >
                                    Get Involved
                                </Link>
                            </motion.div>
                            ...
                            >
                                <Link 
                                    to="/request-demo" 
                                    className="bg-emerald-500 px-6 py-3 rounded-lg hover:bg-emerald-400 transition duration-300 font-medium"
                                >
                                    Request Demo
                                </Link>
                            </motion.div>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">What is NTD360?</h2>
                        <motion.p 
                            ...
                            viewport={{ once: true }}
                        >
                            NTD360 is an intelligent disease forecasting platform that helps health workers, policymakers, epidemiologists, 
                            and organizations anticipate and respond to potential disease outbreaks including COVID-19, diphtheria, 
                            monkeypox, cholera, and reemerging NTDs—especially in endemic regions.
                        </motion.p>
                    </motion.div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        >
                            <p className="text-lg text-gray-600 mb-6">
                                Powered by AI and real-time environmental data, NTD360 transforms public health response at regional, 
                                national, and international levels from reactive to proactive.
                            </p>
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Our platform provides cutting-edge tools to revolutionize disease surveillance and prevention.
                        </p>
                    </motion.div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            {
                                icon: <FaGlobeAfrica className="text-4xl mb-4 text-emerald-600" />,
                ...
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-600 mb-6">
                                NTD360 collects and analyzes data from multiple sources to provide comprehensive insights:
                            </p>
                            ...
                            <p className="text-lg text-gray-600">
                                We use machine learning models like <span className="font-semibold">XGBoost</span> and <span className="font-semibold">LSTM</span>, 
                                hosted on <span className="font-semibold">AWS cloud infrastructure</span>, to process data and generate predictive risk maps and alerts.
                            </p>
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, x: 50 }}
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg mb-8">
                                With Nigeria's doctor-to-patient ratio at 1:5,000 and similar challenges across many regions, 
                                our platform helps maximize limited healthcare capacity, reduce burnout, and support smarter, 
                                faster public health decisions—especially in underserved and high-risk areas.
                            </p>
                            <div className="grid grid-cols-2 gap-4">
                                <AnimatedCounter value="95%" label="Prediction Accuracy" />
                                <AnimatedCounter value="50+" label="Diseases Tracked" />
                                <AnimatedCounter value="10+" label="Countries Served" />
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <div className="text-2xl font-bold text-emerald-600">{partners[currentPartner].logo}</div>
                                <div className="text-gray-700">{partners[currentPartner].name}</div>
                            </motion.div>
                        </AnimatePresence>
                    </motion.div>
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        {partners.map((partner, index) => (
                            ...
                            >
                                <div className="text-xl font-semibold text-emerald-600">{partner.logo}</div>
